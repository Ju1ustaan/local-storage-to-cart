...
const Header = ({isShown, setIsShown}) => {
    ...
    <nav className="flex justify-between bg-gray-900 text-white w-screen">
      ...
      <NavLink to = "/" className="text-3xl font-bold font-heading" >
        ...
        <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          ...
          <li><NavLink className="hover:text-gray-200" to="/">Catagory</NavLink></li>
          <li><NavLink className="hover:text-gray-200" to="/">Collections</NavLink></li>
          <li><NavLink className="hover:text-gray-200" to="/">Contact Us</NavLink></li>
        </ul>
        ...
        <div className="hidden xl:flex items-center space-x-5 items-center">
          ...
          <NavLink className="flex items-center hover:text-gray-200" to="/basket">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a className="flex items-center hover:text-gray-200" href="#"  onClick={() => setIsShown(true)}>
